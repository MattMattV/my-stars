...
- [ceph-ansible](https://github.com/ceph/ceph-ansible) - Ansible playbooks for Ceph
...
- [kubeadm-dind-cluster](https://github.com/Mirantis/kubeadm-dind-cluster) - A Kubernetes multi-node test cluster based on kubeadm
