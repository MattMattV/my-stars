...
- [SLSK](https://github.com/supremesonicbrazil/SLSK) - Steam Linux Swiss Knife - A backup utility and database for Linux Steam games
...
- [FileMasta](https://github.com/HerbL27/FileMasta) - Discover the web for video, music, books, software, games, subtitles and much more
...
- [TextSuggest](https://github.com/bharadwaj-raju/TextSuggest) - Universal Autocomplete
...
- [server](https://github.com/joyread/server) - Self-hosted Free(Libre) Ebook Reader
